...
<html lang="de">
  <head>
    ...
    <title>Yodas Grammar Madness</title>
    
      <style>
        
        h1 {text-align:center; color:#4bd5ee; font: "News Cycle", sans-serif;font-family: Verdana, Geneva, sans-serif;}
        h2 {text-align:center; color: #4bd5ee; opacity: 100; font-family: Verdana, Geneva, sans-serif;}
        p {text-align:center; color:white;}
        body {background-color: black}
        
        table {color: white; text-align: left; margin-left: auto; margin-right: auto;}
      </style>
  ...
  {       
    $text = $_GET['phrase_object'] . " " . $_GET['phrase_subject'] . " " . $_GET['phrase_verb'] ;
    $name = $_GET['pmail'];
    $email = $_GET['pmail'];
   ...
   $sql = "INSERT INTO phrases (phrase, name, email) VALUES ('$text','$email','$name')";
 ...
 // header('Location: '. $_SERVER['PHP_SELF']);   die(); 
  ...
  echo "<h2>A long time ago in a galaxy far, <br> far away.<br>Our story continues " . date('Y') . " years after the battle of Yavin.<h2>";
  ...
  ?>
   ...
   <h1>Much to learn, you still have.</h1>
    ...
    <p><?php
        ...
        if(isset($_GET['btn-save'])){       
          echo "<p>Yoda says: " . $_GET['phrase_object'] . " " . $_GET['phrase_subject'] . " " . $_GET['phrase_verb'] . ". Yes, hmmm." . " Young Padawan " . $_GET['pname'] . "." . "</p>";               
    ...
    <form method="get">
      ...
      <p>
        <select class="custom-select" name="phrase_subject">
        ...
        <select class="custom-select" name="phrase_verb">
        ...
        <select class="custom-select" name="phrase_object">
        ...
        <input type="text" name="pname" placeholder="Your name" value="">

        <input type="text" name="pmail" placeholder="Your email address" value="">

        <button type="submit" class="btn btn-default" name="btn-save" value="1">Do or do not</button>
      <p>

    </form>
           
    <table
    cellspacing="20" class="table-striped table">
...
if (isset($_GET['pmail'])){
  $to      = urldecode($_GET['pmail']);
  $subject = 'Yodas Grammar Madness';
  $message = $text;
  $headers = 'From: lh105@hdm-stuttgart.de' . "\r\n" .
      'Reply-To: lh105@hdm-stuttgart.de' . "\r\n" .
      'X-Mailer: PHP/' . phpversion();

  $mailSuccess = mail($to, $subject, $message, $headers);      

  //Warning: mail(): Failed to connect to mailserver at "localhost" port 25, verify your "SMTP" and "smtp_port" setting in php.ini or use ini_set() in C:\xampp\htdocs\internet5\index.php
...
>
       ...
       Es enthält die Star Wars Titelmelodie. 
       Sie können es unter
       <a href="/localhost/internet/SWTheme.mp3">diesem Link</a>
       abrufen.
  </audio>
